class KDate {
    ...
    add(y, m, d) {
        ...
        this.Date.setFullYear(
            ...
            this.Date.getMonth() + (m || 0),
            this.Date.getDate() + (d || 0)
        );
        return this;
    }
}

[new KDate('2021-01-01 10:00:00').date("년월일"), new KDate('2021-01-01 10:00:00').date('.'), new KDate('2021-01-01 10:00:00').add(0, 0, -3).raw(), new KDate('2021-01-01 10:00:00').add(3, 2, -1).date('.')].forEach(date => console.log(date));
